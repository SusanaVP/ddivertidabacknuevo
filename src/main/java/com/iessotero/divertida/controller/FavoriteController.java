...
/**
 * Controlador REST para gestionar operaciones relacionadas con los favoritos de los usuarios.
 */
@RestController
...
public class FavoriteController {
     ...
     * Este método puede ser accedido por cualquier usuario autenticado.
     *
     * @param contentId el ID del contenido a eliminar de los favoritos.
     * @param idUser el ID del usuario.
     * @param contentType el tipo de contenido a eliminar (video, historia, acertijo, evento).
     */
     ...
     * @param idUser el ID del usuario.
     * @param contentType el tipo de contenido a añadir (video, historia, acertijo, evento).
     */
    @PreAuthorize("isAuthenticated()")
    ...
    /**
     * Obtiene la lista de videos favoritos de un usuario.
     * Este método puede ser accedido por cualquier usuario autenticado.
     *
     * @param idUser el ID del usuario.
    ...
    /**
     * Obtiene la lista de historias favoritas de un usuario.
     * Este método puede ser accedido por cualquier usuario autenticado.
     *
     * @param idUser el ID del usuario.
    ...
    /**
     * Obtiene la lista de adivinanzas favoritos de un usuario.
     * Este método puede ser accedido por cualquier usuario autenticado.
     *
     * @param idUser el ID del usuario.
