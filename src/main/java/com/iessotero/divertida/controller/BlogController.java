...
public class BlogController {
    ...
    /**
     * Valida un blog dado su ID. Este método solo puede ser accedido por administradores.
     *
    ...
    /**
     * Obtiene una lista de blogs no validados. Este método solo puede ser accedido por administradores.
     *
     * @return una lista de objetos {@link Blog}.
     */
    @PreAuthorize("hasRole('ROLE_ADMIN')")
    ...
    /**
     * Incrementa los likes de un blog dado su ID. Este método puede ser accedido por cualquier usuario autenticado.
     *
    ...
    /**
     * Añade un nuevo blog. Este método puede ser accedido por cualquier usuario autenticado.
     *
    ...
    /**
     * Elimina un blog dado su ID. Este método solo puede ser accedido por administradores.
     *
