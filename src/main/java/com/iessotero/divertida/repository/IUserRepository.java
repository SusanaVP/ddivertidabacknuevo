...
public interface IUserRepository extends JpaRepository<User, Long> {
    ...
    /**
     * Verifica si existe un usuario con la combinación de correo electrónico y contraseña dada.
     *
     * @param email    la dirección de correo electrónico del usuario.
     * @param password la contraseña del usuario.
     * @return el ID del usuario si la combinación es válida, o null si no es válida.
     */
